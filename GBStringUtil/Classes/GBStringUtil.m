...
#import "GBStringUtil.h"
#import <CommonCrypto/CommonDigest.h>

@implementation GBStringUtil
...
+ (NSMutableString *)setGapWith:(NSString *)string {
    string = [GBStringUtil trimSpacesOfString:string];
...
+ (NSString *)changeOrgialString:(NSString *)string {
    string = [GBStringUtil trimSpacesOfString:string];
    return [GBStringUtil starsReplacedOfString:string withinRange:NSMakeRange(3, 4)];
}
